...
```{r}
lit_by_focal_area <- ggplot(lit_focal.percent, aes(x="", y=count, fill=Primary.Focal.Area)) +
  ...
  geom_text(aes(x = 1.6, label = paste0(round(percentage, 1), "%")), position = position_stack(vjust = 0.5), size = 10) +
  theme(legend.position = "right", 
        legend.text = element_text(size = 24), 
        legend.title = element_text(size = 28)); lit_by_focal_area
...
```{r}
lit_by_location <- ggplot(lit_focal_location.percent, aes(x="", y=count, fill=Location)) +
  geom_col(color = "black", linewidth = 1.2) +
  coord_polar("y", start=0) + 
  theme_void() +
  #geom_text(aes(label = paste0(round(percentage, 1), "%")), position = position_stack(vjust = 0.5)) +
  ...
  theme(legend.position = "right", 
        legend.text = element_text(size = 24), 
        legend.title = element_text(size = 28)); lit_by_location
...
fig <- ggdraw() +
  ...
  draw_plot(lit_by_area, x = 0.5, y = 0, width = 0.5, height = 0.5) + 
  draw_plot(lit_by_location, x = 0, y = 0, width = 0.5, height = 0.5) + 
  draw_plot_label(label = c("a", "b", "c"), size = 20, x = c(0, 0.5, 0), y = c(0.5, 0, 0))
...
fig <- ggdraw() +
  ...
  draw_plot(lit_by_area, x = 0.5, y = 0, width = 0.5, height = 0.5) + 
  draw_plot(lit_by_location, x = 0, y = 0, width = 0.5, height = 0.5) + 
  draw_plot_label(label = c("a", "b", "c"), size = 20, x = c(0, 0), y = c(1, 0.5))
